...
class LaboresName extends Conexion
{
    ...
    public function getSelect_letra()
    {
        $query = "SELECT lb_zn.id_zona, lb_zn.labZona_letra FROM lab_zonas AS lb_zn;";
        return $this->ConsultaSimple($query);
    }
    // Obtiene Lista especifica
    public function getSelect_zonaNombre()
    {
    ...
    {
        $query = "SELECT lb_zn.id_zona, lb_zn.{$column} FROM lab_zonas AS lb_zn;";
        return $this->ConsultaSimple($query);
    }
    // Obtiene Lista especifica
    ...
    // Obtiene Lista especifica
    public function getSelectWhere(string $column, string $parament, string $columnWhere)
    {
        $where = "WHERE lbN.id_labNombre = '{$parament}'";
        $query = "SELECT {$column}, id_labNombre FROM {$column} " .$where; 
        return $this->ConsultaSimple($query);
    }
