        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Ingreso de Zona</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					...
					<li><a href="#">Zona</a></li>
					<li class="active">Ingreso de Zona</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
					            ...
					            <form class="form-horizontal">
					                <div class="panel-body">
                                        ...
                                        <div class="form-group">
					                        <label for="formIptTextCodigo" class="col-sm-3 control-label">Código</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="Código" class="form-control" id="formIptTextCodigo">
					                        </div>
					                    </div>
                                        <div class="form-group">
                    ...
                    <div id="alerts-Edit">
					            ...
					            <form class="form-horizontal">
					                <div class="panel-body">
                                        <!-- FORMULARIO -->
                                        <div class="form-group">
					                        <label for="demo-is-inputnormal" class="col-sm-3 control-label">Código</label>
					                        <div class="col-sm-6">
