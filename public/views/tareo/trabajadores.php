        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="./../img/logo-exploraciones-andinas.png" alt="MDN" style="width: 100%;">
                        </div>
                        <div class="col-md-8">
                            <p class="bord-btm pad-ver text-main text-bold">Datos personales</p>
                            <div class="row">

                                    <label for="" class="col-md-2 control-label">Ape.Paterno</label>
                                    <div class="col-md-2">                                                    
                                        <input type="texto" placeholder="n° vale" class="form-control" id=""  value="" >
                                    </div>
                                

                                    <label for="" class="col-md-2 control-label">Ape.Materno</label>
                                    <div class="col-md-2">                                                    
                                        <input type="texto" placeholder="n° vale" class="form-control" id=""  value="" >
                                    </div>
                                    ...
                                    <label for="val_explosivo-text-form-fecha" class="col-md-2 control-label">Fec.Nac:</label>
                                    <div class="col-md-2">                                                    
                                    ...
                                    <!-- Default choosen -->
                                    <!--===================================================-->
                                    <select class="form-control chosenZona" data-placeholder="Elija una opcion" id="" tabindex="2">
                                        ...
                                        <label for="" class="col-md-2 control-label">Guardia</label>
                                        <div class="col-md-2s">
                                            <!-- Default choosen -->
                                            <!--===================================================-->
                                            <select class="form-control chosenZona" data-placeholder="Elija una opcion" id="" tabindex="2">
