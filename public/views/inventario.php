					        ...
					        <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
					            <thead>
					                <tr>
					                    ...
					                    <th data-sort-initial="true" data-toggle="true">Ingresos</th>
					                    <th data-sort-initial="true" data-toggle="true">Salidas</th>
					                    <th>Saldo</th>
					                    <th data-hide="phone, tablet">Operacion</th>
                                ...
                                <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="" class="col-md-4 control-label">Almacen</label>
                                                        <div class="col-md-8">
                                                            <!-- Default choosen -->
                                                            <!--===================================================-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="" class="col-md-4 control-label">Producto</label>
                                                        <div class="col-md-4">
                                                            <input type="text" placeholder="Producto" class="form-control" id="">
                                                        </div>
                                                        <div class="col-md-4">
                                                            <input type="text" placeholder="Uni. Medida" class="form-control" id="">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="col-md-4 control-label">Periodo: </label>
                                                        <div class="col-md-8">
                                                            <input type="month" class="form-control" value="2019-08">
                                                        </div>
                                                    </div>                                                    
                                                </div>
                                            </div>
