                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane pad-btm fade in active" id="demo-bsc-tab-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" class="form-control" name="fullName" placeholder="Codigo">
                                                </div>
                                                <div class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" name="company" placeholder="Descripción">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">Nombre generico</label>
                                                <div class="col-lg-7">
                                                    <input type="text" class="form-control" name="company" placeholder="Nombre generico">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">Estante Medicina</label>
                                                <div class="col-lg-7">
                                                    <input type="text" class="form-control" name="company" placeholder="Estante Medicina">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">Tipo de Medicina</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    <select class="selectpicker">
                                                        <option>Laboratorio Chile</option>
                                                        <option>CSS</option>
                                                        <option>jQuery</option>
                                                        <option>Javascript</option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">Unidad Medina</label>
                                                <div class="col-lg-7">
                                                    <select class="selectpicker">
