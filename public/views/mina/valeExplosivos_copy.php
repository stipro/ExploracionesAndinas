        ...
        <div id="inserForm"  class="modal-dialog modal-lg" style="margin: 1rem;">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Ingreso de Vales de Explosivos</h4>
                </div>
                <!--Modal body-->
                <div class="modal-body">
                    <div id="alert-form-insert">
                    </div>
                    <div id="pruebaforma" class="form-horizontal" action="#" method="post">
                        <div class="col-md-12" id="group1Form">
                            <div class="col-md-2" id="g1item1Form">
                                <p class="bord-btm pad-ver text-main text-bold">Informacion General del Vale</p>
                                <fieldset>
                                    <div class="row">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" placeholder="..." class="form-control" name="digitador"id="val_explosivo-ipt-text-form-digitador" data-ccosto="<?php echo $_SESSION["code"]?>" value="<?php echo $_SESSION["name"]?>" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <!-- Default choosen -->
                                                        <!--===================================================-->
                                                        <select class="form-control chosenZona" data-placeholder="Elija una opcion." id="val_explosivo-text-form-zona" tabindex="2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" placeholder="Nª Vale" class="form-control" name="fullname" id="val_explosivo-text-form-n_vale">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <!-- Default choosen -->
                                                        <!--===================================================-->
                                                        <select class="form-control chosenTurno" data-placeholder="Choose a Country..." id="val_explosivo-text-form-turno" tabindex="2">
                            ...
                            <br>
                            <div class="col-md-10" id="g1item2Form">
                                ...
                                <fieldset>
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <div id="contChosenLaborNombre" class="col-md-12">
                                                    <!-- Default choosen -->
                                                    <!--===================================================-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Tipo de Disparo</label>
                                                <div class="col-md-4">
                                        ...
                                        <div class="col-md-6">
                                            <div id="alert-perforitsta" class="col-md-12">
                                            ...
                                            <div class="col-md-12">                                                
                                                ...
                                                <!--
                                                <div class="col-md-1" id="validadorPerforista-icon">
                                                    <!--<i class="ion-checkmark-circled"></i>
                                                    <i class="ion-close-circled"></i>
                                                </div>
                                                <div class="col-md-3">
                                                    <button class="btn btn-default" id="btn-search-Perforista">Buscar</button>
                                                </div>-->
                        ...
                        <div class="col-md-12" id="group2Form">
                            <!--
                            <div class="col-md-4" id="g2item1Form">
                                <p class="bord-btm pad-ver text-main text-bold">Cargar a</p>
                                <fieldset>
                                    <!-- FORMULARIO 
                                    <div class="form-group">
                                        <label for="formIptNumberNTarjeta" class="col-md-4 control-label">Cta Labor</label>
                                        <div class="col-md-8">
                                            <input type="text" placeholder="Cta Labor" class="form-control" id="formIptNumberNTarjeta">
                                        </div>
                                    </div>
                                    <!-- FORMULARIO 
                                    <div class="form-group">
                                        <label for="formIptNumberNTarjeta" class="col-md-4 control-label">Análisis</label>
                                        <div class="col-md-8">
                                            <input type="text" placeholder="Análisis" class="form-control" id="formIptNumberNTarjeta">
                                        </div>
                                    </div>
                                    <!-- FORMULARIO 
                                    <div class="form-group">
                                        <label for="formIptNumberNTarjeta" class="col-md-4 control-label">Nivel</label>
                                        <div class="col-md-8">
                                            <input type="text" placeholder="Nivel" class="form-control" id="formIptNumberNTarjeta">
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                            -->
                            <div class="col-md-12" id="g2item2Form">
                                <p class="bord-btm pad-ver text-main text-bold">Registro de Perforadoras</p>
                                <fieldset>
                                    <div class="row group1RegPerf">
                                        <div class="col-md-2 item1RegPerf">Barra
                                            <input class="form-control" type="number" name="" id="val_explosivo-input-form-barra">
                                        </div>
                                        <div class="col-md-2 item1RegPerf">Lgt (mt)
                                            <input class="form-control" type="number" name="" id="val_explosivo-input-form-lgt_mt">
                                        </div>
                                        <div class="col-md-2 item1RegPerf">N° Taladros
                                            <input class="form-control" type="number" name="" id="val_explosivo-input-form-n_taladro">
                                        </div>
                                        <div class="col-md-2 item1RegPerf">Tal_Vacio
                                            <input class="form-control" type="number" name="" id="val_explosivo-input-form-tal_vacio">
                                        </div>
                                        <div class="col-md-2 item1RegPerf">Pies Perf
                                            <input class="form-control" type="number" name="" id="val_explosivo-input-form-pies_perf" disabled>
                                        </div>
                                        <div class="col-md-2 item1RegPerf">Pie Real
                                            <input class="form-control" type="number" name="" id="val_explosivo-input-form-pies_real" disabled>
                                        </div>
                                        <div class="col-md-2 item1RegPerf">
                                            N° Maq
                                                <!-- Default choosen -->
                                                <!--===================================================-->
                                                <select class="form-control chosenLabNombre" data-placeholder="Choose a Country..." id="val_explosivo-text-form-nmaquianas" tabindex="2">
                                                    <option id="optlabNombre" value="">PA_20</option>
                                                    <option id="optlabNombre" value="">PA_30</option>
                                                    <option id="optlabNombre" value="">PA_36</option>
                                                    <option id="optlabNombre" value="">PS_04</option>
                                                    <option id="optlabNombre" value="">PS_05</option>
                                                    <option id="optlabNombre" value="">PS_06</option>
                                                    <option id="optlabNombre" value="">PS_07</option>
                                                    <option id="optlabNombre" value="">PSS_01</option>
                                                    <option id="optlabNombre" value="">PSecan_01</option>
                                                    <option id="optlabNombre" value="">PSecan_02</option>
                                                    <option id="optlabNombre" value="">PSecan_03</option>
                                                </select>
                                                <!--===================================================-->
                                        </div>
                                    </div>
                                    <div class="row group2RegPerf">
                                        <div class="col-md-2 item2RegPerf">
                                            <!--State Button-->
                                            <!--===================================================-->
                                            <button id="btn-Calcular" class="btn btn-lg btn-info" data-loading-text="Loading..." type="button">
                                                Validar
                                            </button>
                                            <!--===================================================-->
                                        </div>
                                        <div class="col-md-2 item2RegPerf">Min / Des
                                            ...
                                            <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="5">
                                                ...
                                                <tbody id="tbody-tareo">
                                                    <tr>
                                                        ...
                                                        <td>CAR</td>
                                                        <td data-type="number">
                                                            <input type="number" class="form-control" id="val_explosivo-text-form-valdin_semi" name="">
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>CAR</td>
                                                        <td data-type="number">
                                                            <input type="number" class="form-control" id="val_explosivo-text-form-valdin_pulv" name="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>SSO 000652</td>
                                                        ...
                                                        <td>CAR</td>
                                                        <td data-type="number">
                                                            <input type="number" class="form-control" id="val_explosivo-text-form-emulnor_mil" name="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>SSO 000631</td>
                                                        <td>Emulsion Emulnor 3000 I"X7"</td>
                                                        <td>CAR</td>
                                                        <td data-type="number">
                                                            <input type="number" class="form-control" id="val_explosivo-text-form-emulnor_tresmil" name="">
                                                        </td>                                                        
                                                    </tr>
                                                    <tr>
                                                        <td>SSO 000438</td>
                                                        <td>Mecha Rapida Z18</td>
                                                        <td>MTS</td>
                                                        <td data-type="number">
                                                            <input type="number" class="form-control" id="val_explosivo-text-form-mecha_rapida_zdiesocho" name="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>SSO 000436</td>
                                                        ...
                                                        <td>MTS</td>
                                                        <td data-type="number">
                                                            <input type="number" class="form-control" id="val_explosivo-text-form-mecha" name="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>SSO 000454</td>
                                                        <td>Fulminante N°8</td>
                                                        <td>UND</td>
                                                        <td data-type="number">
                                                            <input type="number" class="form-control" id="val_explosivo-text-form-fuminante_ocho" name="">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>SSO 000514</td>
                                                        ...
                                                        <td>UND</td>
                                                        <td data-type="number">
                                                            <input type="number" class="form-control" id="val_explosivo-text-form-conecto_mecha" name="">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
