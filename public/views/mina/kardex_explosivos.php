					            ...
					            <div class="panel-body">
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-sm-4">
                                                <div class="form-group">
                                                    <label for="slt-explosivosKardex-Almacen" class="col-sm-3 col-md-4control-label">Almacen</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-sm-4">
                                                <div class="form-group">
                                                    <label for="almacen-kardex" class="col-sm-3 col-md-4 control-label">Producto:</label>
                                                    <div class="col-sm-5 col-md-8">
                                                        <input type="text" class="form-control input-sm" id="almacen-kardex" placeholder="Codígo">
                                                    </div>
                                                    <div class="col-sm-4 col-md-8">
                                                        <input type="text" class="form-control input-sm" id="almacen-kardex" placeholder="Und.">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-4">
                                                <div class="form-group">
                                                    <div class="col-sm-12 col-md-12">
                                                        <input type="text" class="form-control input-sm" id="slt-explosivosKardex-nombre" placeholder="Nombre Explosivo" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 input-group mar-btm">
                                                        ...
                                                        <input type="month" class="form-control input-sm" id="cst-ipt-explosivosKardex-Periodo" placeholder="Mes">
                                                        <span class="input-group-btn">
                                                            <button class="btn btn-mint btn-sm" type="button">
