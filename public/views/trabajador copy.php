...
<body>
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                <div id="page-head">
                    ...
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Ingreso de Trabajador</h1>
                    </div>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End page title-->
					...
					<li><a href="#">Tareo</a></li>
					<li class="active">Ingreso de Trabajador</li>
                    </ol>
                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                    <!--End breadcrumb-->
                                                ...
                                                <div class="col-sm-6 table-toolbar-right">
                                                    <div class="btn-group">
                                                        ...
                                                        <select data-placeholder="Choose a Country..." id="demo-chosen-select" tabindex="2">
                                                            <option date-column="col_ccostos" value="CCostos">ccostos</option>
                                                            <option date-column="col_dni" value="dni">dni</option>
                                                            <option date-column="col_nombre" value="nombre">nombre</option>
                                                            <option date-column="col_cargo_actual" value="cargo_actual">cargo_actual</option>
                                                            <option date-column="col_area" value="area">area</option>
                                                            <option date-column="col_guardia" value="guardia">guardia</option>
                                                            <option date-column="col_situacion"value="situacion">situacion</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="5">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th data-sort-initial="true" data-toggle="true">C. Costo</th>
                                                        <th>D.N.I.</th>
                                                        <th data-hide="phone, tablet">Nombre</th>
                                                        <th data-hide="phone, tablet">Cargo Actual</th>
					            ...
					            <form class="form-horizontal">
					                <div class="panel-body">
                                        ...
                                        <div class="form-group">
					                        <label for="formIptTextCCosto" class="col-sm-3 control-label">C. Costo</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="C. Costo" class="form-control" id="formIptTextCCosto">
					                        </div>
					                    </div>
                                        <div class="form-group">
					                        <label for="formIptTextDni" class="col-sm-3 control-label">DNI</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="DNI" class="form-control" id="formIptTextDni">
					                        </div>
					                    </div>
                                        <div class="form-group">
					                        <label for="formIptTextNombre" class="col-sm-3 control-label">Apellidos y Nombres</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="Apellidos y Nombres" class="form-control" id="formIptTextNombre">
					                        </div>
					                    </div>
                                        <div class="form-group">
					                        <label for="formIptTextCargo" class="col-sm-3 control-label">Cargo</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="Cargo" class="form-control" id="formIptTextCargo">
					                        </div>
					                    </div>
                                        <div class="form-group">
					                        <label for="formIptTextArea" class="col-sm-3 control-label">Área</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="Área" class="form-control" id="formIptTextArea">
					                        </div>
					                    </div>
                                        <div class="form-group">
					                        <label for="formIptTextGuardia" class="col-sm-3 control-label">Guardia</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="Guardia" class="form-control" id="formIptTextGuardia">
					                        </div>
					                    </div>
                                        <div class="form-group">
					                        <label for="formIptTextSituacion" class="col-sm-3 control-label">Situación</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="Situación" class="form-control" id="formIptTextSituacion">
					                        </div>
					                    </div>
					                </div>
					            </form>
                ...
                <div id="alerts-Edit">
					            ...
					            <form class="form-horizontal">
					                <div class="panel-body">
                                        ...
                                        <!-- FORMULARIO -->
                                        <div class="form-group">
					                        <label for="formIptTextCCostoEdit" class="col-sm-3 control-label">C. Costo</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="C. Costo" class="form-control" id="formIptTextCCostoEdit">
					                        </div>
					                    </div>
                                        <div class="form-group">
					                        <label for="formIptNumbDniEdit" class="col-sm-3 control-label">D.N.I. (*)</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="DNI" class="form-control" id="formIptNumbDniEdit">
					                        </div>
					                    </div>
                                        <div class="form-group">
					                        <label for="formIptTextApelNombresEdit" class="col-sm-3 control-label">Apellidos y Nombres</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="Apellidos y Nombres" class="form-control" id="formIptTextApelNombresEdit">
					                        </div>
					                    </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
					                        <label for="formIptTextAreaEdit" class="col-sm-3 control-label">Área</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="Área" class="form-control" id="formIptTextAreaEdit">
					                        </div>
					                    </div>
                                        <div class="form-group">
					                        <label for="formIptTextGuardiaEdit" class="col-sm-3 control-label">Guardia</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="Guardia" class="form-control" id="formIptTextGuardiaEdit">
					                        </div>
					                    </div>
                                        <div class="form-group">
					                        <label for="formIptTextSituacionEdit" class="col-sm-3 control-label">Situación</label>
					                        <div class="col-sm-6">
					                            <input type="text" placeholder="Guardia" class="form-control" id="formIptTextSituacionEdit">
					                        </div>
					                    </div>
					                </div>
					            </form>
    ...
    <!--Date-MYSQL [ REQUIRED ]-->
    <script src="..\js\trabajador.js"></script>
