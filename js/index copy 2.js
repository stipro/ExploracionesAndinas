...
const fetchNav = async (id_Usuario) => {
    ...
    const mainnavcontainer_Antiguo = document.getElementById("mainnav-container");
    ...
    data = await res.json()
    rpt_template = await pintarNav(data);
    navMainnav_container.innerHTML = rpt_template;
    contenedor_boxed.replaceChild(navMainnav_container, mainnavcontainer_Antiguo);
...
const pintarNav = data => {
    ...
    navMainnav_template += template_Modulo + '\
